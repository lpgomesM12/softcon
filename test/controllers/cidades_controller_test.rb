...
class CidadesControllerTest < ActionController::TestCase
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post :create, cidade: { estado_id: @cidade.estado_id, flag_ativo: @cidade.flag_ativo, nome_cidade: @cidade.nome_cidade }
    end
  ...
  test "should update cidade" do
    patch :update, id: @cidade, cidade: { estado_id: @cidade.estado_id, flag_ativo: @cidade.flag_ativo, nome_cidade: @cidade.nome_cidade }
    assert_redirected_to cidade_path(assigns(:cidade))
  end
