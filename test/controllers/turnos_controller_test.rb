...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { data_entrega: @turno.data_entrega, desc_relatorio: @turno.desc_relatorio, flag_entregue: @turno.flag_entregue, user_id: @turno.user_id }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { data_entrega: @turno.data_entrega, desc_relatorio: @turno.desc_relatorio, flag_entregue: @turno.flag_entregue, user_id: @turno.user_id }
    assert_redirected_to turno_path(assigns(:turno))
  end
