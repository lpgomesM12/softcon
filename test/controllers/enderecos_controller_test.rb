...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro_id: @endereco.bairro_id, desc_cep: @endereco.desc_cep, desc_endereco: @endereco.desc_endereco }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro_id: @endereco.bairro_id, desc_cep: @endereco.desc_cep, desc_endereco: @endereco.desc_endereco }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
