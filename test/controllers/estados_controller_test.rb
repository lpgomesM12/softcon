...
class EstadosControllerTest < ActionController::TestCase
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post :create, estado: { flag_ativo: @estado.flag_ativo, nome_estado: @estado.nome_estado, sigl_estado: @estado.sigl_estado }
    end
  ...
  test "should update estado" do
    patch :update, id: @estado, estado: { flag_ativo: @estado.flag_ativo, nome_estado: @estado.nome_estado, sigl_estado: @estado.sigl_estado }
    assert_redirected_to estado_path(assigns(:estado))
  end
