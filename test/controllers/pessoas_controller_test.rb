...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { cpf: @pessoa.cpf, desc_fone: @pessoa.desc_fone, nome_pessoa: @pessoa.nome_pessoa, rg: @pessoa.rg }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { cpf: @pessoa.cpf, desc_fone: @pessoa.desc_fone, nome_pessoa: @pessoa.nome_pessoa, rg: @pessoa.rg }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
